const CACHE_NAME="salmon-dark-rivers-v31";
const OFFLINE_ASSETS=["./","./styles.20260920-31.css","./app.20260920-31.js",
"./data.20260919-21.js","./site-config.20260919-21.js","./manifest.webmanifest","./data/network-mobile.png","./icon.svg","./icon-192.png","./icon-512.png"];
